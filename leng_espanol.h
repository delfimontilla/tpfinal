...
#define MSJ_BIENVENIDA "Bienvenide a la Simpletron! Por favor, ingrese su programa una instrucción (o dato) a la vez. Yo escribiré la ubicación y un signo de pregunta (?).Luego usted ingrese la palabra para esa ubicación. Se debe verificar que se haya ingresado el opcode 45 para que la ejecución sea existosa. Ingrese -99999999 para finalizar."

#define MSJ_CARGA_COMPLETA "*** Carga del programa completa ***"
#define MSJ_COMIENZO_EJECUCION "*** Comienza la ejecución del programa ***"

#define MSJ_ACLARACION_AYUDA1 "Los argumentos que acompañaran a la ejecucion son posicionales, pero estos pueden estar o no presentes, por lo tanto, se deberán colocar en el orden mostrado a continuación."
#define MSJ_ACLARACION_AYUDA2 "El primer argumento posible es '-m' que precederá la cantidad de palabras a ingresar, cuyo default es 50. El siguiente es el formato de salida, indicando '-f' con txt o bin (por omisión, será txt). Si se quiere que la entrada de instrucciones sea por stdin se deberá colocar '-', en caso contrario se deben ingresar los diferentes archivos indicando antes el formato como por ejemplo t:suma.lms para un archivo de texto o b:suma.bin para un archivo binario, en caso de no especificar el formato se asumirá que es txt.\n "
